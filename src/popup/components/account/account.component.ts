      ...
      <div class="settings-content">
        <div class="settings-section">
          ...
          <div class="action-item">
            ...
            <label class="toggle-switch" *ngIf="isLoaded()">
              <input
                type="checkbox"
          ...
          <div class="action-item">
            ...
            <button class="btn-logout" (click)="showLogoutAllConfirm.set(true)">
              Log out All
            </button>
          </div>
          ...
          <div class="action-item">
            ...
            <button class="btn-logout" (click)="showWipeConfirm.set(true)">
              Wipe All
            </button>
          </div>
        </div>
